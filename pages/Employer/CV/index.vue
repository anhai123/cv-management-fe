...
const getAllPagination = async () => {
    var response = await api.get(
        `/CV/GetAllPaginationCv?PageSize=${pageSize.value}&PageNumber=${pageNumber.value}&jobPostId=${props.jobPostId}`,
    );
...
const excelExport = async () => {
    ...
    queryParams.push(`jobPostId=${props.jobPostId}`)
...
const submitForm = async () => {
    ...
    formData.append('jobPostId', props.jobPostId);
