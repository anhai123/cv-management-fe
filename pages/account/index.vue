            ...
            <div class="search">
                ...
                <form name="search" @submit.prevent="searchByEmailOrName()">
                    ...
                    <div class="search-text d-flex align-content-center">
                        <div class="col-md-3">
                            <input class="form-control col-md-2" v-model="searchString" type="text"
                                placeholder="Nhập email hoặc họ tên... " />
                        </div>
                        <span class="button d-flex">
                            <button class="ms-2 btn-sm me-1 btn btn-primary" type="submit">
                            ...
                            <button class="btn btn-sm btn-outline-primary" type="reset" @click="resetSearchForm()">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em"
                                    viewBox="0 0 256 256">
                                    <path fill="currentColor"
            ...
            <div class="data">
                <div class="btn-handle d-flex justify-content-end mb-3">
                    <div class="handle-create">
                        <TheFormCreateUpdateAccount :isEditMode="isEditMode" :roles="roles"
                            :id_modal="'create-account-modal'" :data_bs_target_modal="'#create-account-modal'"
                            @account-saved="getAccounts" />
                        <a @click="onCreateMode" href="#" data-bs-toggle="modal"
                ...
                <table class="table text-center table-hover table-striped-columns">
                    ...
                    <tbody class="table-success">
                        <tr v-for="(account, index) in accounts" :key="index">
                            ...
                            <td>
                                <div v-if="account.email !== currentEmail"
                                    class="d-flex justify-content-center align-content-center align-items-center">
                                    <NuxtLink class="link link-primary text-decoration-none mx-1" data-bs-toggle="modal"
                                        :data-bs-target="'#update-account-modal'" @click="accountEdit(account)"
                                    ...
                                    <NuxtLink class="link link-primary text-decoration-none mx-1" data-bs-toggle="modal"
                                        ...
                                        @click="resetPasswordAccount(account.id)" style="cursor: pointer">
                                        <i class="fa-solid fa-key" style="font-size: 0.77em"></i>
                                    </NuxtLink>

                                    <NuxtLink class="link link-danger text-decoration-none mx-1" style="cursor: pointer"
                                        @click="deleteAccount(account.id)" data-bs-toggle="modal"
                ...
                <TheFormCreateUpdateAccount :isEditMode="isEditMode" :editAccount="editAccountData" :roles="roles"
                    :id_modal="'update-account-modal'" :data_bs_target_modal="'#update-account-modal'"
                    @account-saved="getAccounts" />

                <ChangePasswordModal :accountId="selectedAccountId" :isAdminChangeMode="true" />

                <DeleteAccountModal :accountId="selectedAccountId" @account-deleted="getAccounts" />
