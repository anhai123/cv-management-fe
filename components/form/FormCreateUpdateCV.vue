                                    ...
                                    <article
                                        ...
                                        <span class="text-wrap mt-1">
                                            <Field as="select" required :rules="{ required: true }"
                                                ...
                                                <option :rules="{ required: true }" class="text-dark"
                                                    name="job-position" v-for="position in positionData"
                                                    :value="position.id">
...
const jobPostingId = route.params.id;
...
const submitForm = async (event) => {
    if (props.idCv == null) {
        ...
        //Link file CV upload to firebase
