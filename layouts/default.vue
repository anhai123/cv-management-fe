    ...
    <div class="container-fluid">
        <div class="row  pt-3 pb-2">
            <div class="col-lg-3 ms-3 d-flex flex-row">
                <div class="text-primary fw-bold  h4">Job Hunter {{ role }}</div>
        ...
        <div class="row border-top">
            <div class="col-lg-2 bg-white p-0" v-if="showSideBar">
                <div class="position-relative sidebar" tabindex="-1">
                    ...
                    <section v-else-if="role === ROLE.EMPLOYER">
                        <!-- <sidebar-admin /> -->
                        <sidebar-employer />
                    </section>
                    <section v-else>
            ...
            <div :class="(showSideBar ? 'col-lg-10' : 'col-lg-12') +
                ...
                <slot />
                <!-- </div> -->
                <div class="d-flex flex-row bottom-0 footer p-0 border-top m-0 position-fixed" style="z-index: 1000;">
                    <div :class="(showSideBar ? 'col-lg-4' : 'col-lg-6') + '  mt-2 ps-2  ms-2'
                        ...
                        2024 <span class="text-primary"> Job Hunter </span>
                    </div>
                    <!-- <div :class="(showSideBar ? 'col-lg-6' : 'col-lg-6') +
                        '  d-flex justify-content-end mt-2 Powered'
                        ">
                        Powered by <span class="text-primary ms-1"> Job hunter </span>
                    </div> -->
                </div>
            </div>
        </div>
...
if (typeof localStorage !== 'undefined') {
    ...
    if (jwtToken) {
        try {
            ...
            UserInformationLocal.setUserInformation(role, userFullName, accountId);
        } catch (error) {
...
const signOut = () => {
    api.postAPI('/Account/logout', {}).then((res) => {
        ...
        localStorage.clear();
        UserInformationLocal.clearUserInformation();
        navigateTo('/');
    });
};
</script>
